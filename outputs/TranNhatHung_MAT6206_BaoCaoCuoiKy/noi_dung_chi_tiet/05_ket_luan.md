...
- **Phạm vi dữ liệu.** Nghiên cứu chỉ sử dụng một năm khởi tạo (2016) của một tổ chức (Freddie Mac) cho một loại sản phẩm (vay thế chấp lãi suất cố định); kết quả chưa chắc khái quát được cho các loại khoản vay hoặc thị trường khác.
...
- **Mở rộng dữ liệu:** kết hợp nhiều năm khởi tạo để kiểm tra độ ổn định của ma trận chuyển giữa các thế hệ khoản vay.
